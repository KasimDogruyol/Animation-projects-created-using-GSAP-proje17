"use strict"
const quantnodes = 333; //reduce the number of nodes to speed up work
const surfWidth = 900;
...
document.onkeydown = function(e) {
	switch (e.key) {
    case "ArrowUp":    typeFig += 0.01; break;
    case "ArrowDown":  typeFig -= 0.01; break;
		case "ArrowLeft":  density += 10; break;
		case "ArrowRight": density -= 10; break;
    //With the keys 2, 3, 4, 5, you can set the surface types shown at the end of the lesson
    case "2": {typeFig = 0.815; density = -90; break;}
    case "3": {typeFig = 3.015; density = -1249777; break;}
		case "4": {typeFig = 0.585; density = 55; break;}
		case "5": {typeFig = 1.922; density = 79674; break;}
	}
}
